...
main:   type.h  Vertex.h initialisation.h matrix_generator.h solver.h vector.h $(CDIR)*.h main.cpp
	g++ $(FFLAG) initialisation.cpp matrix_generator.cpp solver.cpp vector.cpp main.cpp -o result
